...
// type GenerateStoreValueMap<T extends readonly IdbObjectStoreConfigs[]> = {
//     [K in T[number]["name"]]: Extract<T[number], { name: K }> extends IdbObjectStoreConfigs<K, infer ValueType>
//         ? ValueType
//         : never;
// };
