 ...
 */
type GeneratePDFRequestBody = z.infer<typeof GeneratePDFRequestSchema>;

/**
 * Handler for POST requests to generate a PDF.
 *
...
export async function POST(request: Request) {
    try {
        ...
        const parsedBody = GeneratePDFRequestSchema.safeParse(body);
        ...
        const pdfBuffer = await generator.generateProblemSetPDF({
            title: title || "Custom Problem Set",
            content: problems,
            answers,
            memos,
        });
